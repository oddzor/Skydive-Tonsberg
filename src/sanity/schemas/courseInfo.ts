...
export const courseInfoSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'heroStats',
      title: 'Key Stats (4 stat boxes)',
      description: 'The four highlighted numbers shown under the video',
      type: 'object',
      group: 'hero',
      fields: [
        defineField({ name: 'theoryDaysNo', title: 'Theory Days Value (Norwegian)', type: 'string', description: 'e.g. 1,5' }),
        defineField({ name: 'theoryDaysEn', title: 'Theory Days Value (English)', type: 'string', description: 'e.g. 1.5' }),
        defineField({ name: 'jumpsCount', title: 'Number of Jumps', type: 'string', description: 'e.g. 7' }),
        defineField({ name: 'windTunnelValue', title: 'Wind Tunnel Duration', type: 'string', description: 'e.g. 10 min' }),
        defineField({ name: 'minAgeNo', title: 'Minimum Age (Norwegian)', type: 'string', description: 'e.g. 16 år' }),
        defineField({ name: 'minAgeEn', title: 'Minimum Age (English)', type: 'string', description: 'e.g. 16 years' }),
      ],
    }),
    defineField({
      name: 'courseDetails',
      title: 'Course Details Card',
      description: 'The four detail rows shown in the right card of the hero section',
      type: 'object',
      group: 'hero',
      fields: [
        defineField({ name: 'durationDescNo', title: 'Duration Description (Norwegian)', type: 'string' }),
        defineField({ name: 'durationDescEn', title: 'Duration Description (English)', type: 'string' }),
        defineField({ name: 'jumpsDescNo', title: 'Jumps Description (Norwegian)', type: 'string' }),
        defineField({ name: 'jumpsDescEn', title: 'Jumps Description (English)', type: 'string' }),
        defineField({ name: 'altitudeDescNo', title: 'Exit Altitude Description (Norwegian)', type: 'string' }),
        defineField({ name: 'altitudeDescEn', title: 'Exit Altitude Description (English)', type: 'string' }),
        defineField({ name: 'ageDescNo', title: 'Age Requirement Description (Norwegian)', type: 'string' }),
        defineField({ name: 'ageDescEn', title: 'Age Requirement Description (English)', type: 'string' }),
      ],
    }),
    defineField({
