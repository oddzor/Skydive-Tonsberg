...
export const courseInfoSchema = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'classroom', title: 'Banner Image — Wide (below hero)', type: 'image', group: 'images', options: { hotspot: true }, fields: [defineField({ name: 'altNo', title: 'Alt Text (Norwegian)', type: 'string', validation: (Rule) => Rule.required() }), defineField({ name: 'altEn', title: 'Alt Text (English)', type: 'string', validation: (Rule) => Rule.required() })] }),
    defineField({ name: 'studentInAction', title: 'Progression Section — Right', type: 'image', group: 'images', options: { hotspot: true }, fields: [defineField({ name: 'altNo', title: 'Alt Text (Norwegian)', type: 'string', validation: (Rule) => Rule.required() }), defineField({ name: 'altEn', title: 'Alt Text (English)', type: 'string', validation: (Rule) => Rule.required() })] }),
    defineField({ name: 'groupPhoto1', title: 'Group Photos — Left', type: 'image', group: 'images', options: { hotspot: true }, fields: [defineField({ name: 'altNo', title: 'Alt Text (Norwegian)', type: 'string', validation: (Rule) => Rule.required() }), defineField({ name: 'altEn', title: 'Alt Text (English)', type: 'string', validation: (Rule) => Rule.required() })] }),
    defineField({ name: 'groupPhoto2', title: 'Group Photos — Center', type: 'image', group: 'images', options: { hotspot: true }, fields: [defineField({ name: 'altNo', title: 'Alt Text (Norwegian)', type: 'string', validation: (Rule) => Rule.required() }), defineField({ name: 'altEn', title: 'Alt Text (English)', type: 'string', validation: (Rule) => Rule.required() })] }),
    defineField({ name: 'groupPhoto3', title: 'Group Photos — Right', type: 'image', group: 'images', options: { hotspot: true }, fields: [defineField({ name: 'altNo', title: 'Alt Text (Norwegian)', type: 'string', validation: (Rule) => Rule.required() }), defineField({ name: 'altEn', title: 'Alt Text (English)', type: 'string', validation: (Rule) => Rule.required() })] }),
    defineField({ name: 'soloStudent', title: 'Progression Section — Left', type: 'image', group: 'images', options: { hotspot: true }, fields: [defineField({ name: 'altNo', title: 'Alt Text (Norwegian)', type: 'string', validation: (Rule) => Rule.required() }), defineField({ name: 'altEn', title: 'Alt Text (English)', type: 'string', validation: (Rule) => Rule.required() })] }),
    defineField({ name: 'packingCourse', title: 'A-License Section — Center Wide', type: 'image', group: 'images', options: { hotspot: true }, fields: [defineField({ name: 'altNo', title: 'Alt Text (Norwegian)', type: 'string', validation: (Rule) => Rule.required() }), defineField({ name: 'altEn', title: 'Alt Text (English)', type: 'string', validation: (Rule) => Rule.required() })] }),
    defineField({ name: 'licenseCelebration', title: 'A-License Section — Bottom Left', type: 'image', group: 'images', options: { hotspot: true }, fields: [defineField({ name: 'altNo', title: 'Alt Text (Norwegian)', type: 'string', validation: (Rule) => Rule.required() }), defineField({ name: 'altEn', title: 'Alt Text (English)', type: 'string', validation: (Rule) => Rule.required() })] }),
  ],
  preview: {
    select: {},
    prepare() {
