              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-muted rounded-lg">
                    <p className="font-semibold mb-1">📅 {t('kurs.details.durationTitle')}</p>
                    <p className="text-sm text-muted-foreground">
                      {t('kurs.details.durationDesc')}
                    </p>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    <p className="font-semibold mb-1">🪂 {t('kurs.details.jumpsTitle')}</p>
                    <p className="text-sm text-muted-foreground">
                      {t('kurs.details.jumpsDesc')}
                    </p>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    <p className="font-semibold mb-1">🎯 {t('kurs.details.altitudeTitle')}</p>
                    <p className="text-sm text-muted-foreground">
                      {t('kurs.details.altitudeDesc')}
                    </p>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    <p className="font-semibold mb-1">👥 {t('kurs.details.ageTitle')}</p>
                    <p className="text-sm text-muted-foreground">
